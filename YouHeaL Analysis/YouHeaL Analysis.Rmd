...
#Table 1 Sociodemographics{.tabset}
...
This is a preliminary analysis done for data collection through summer 2019, which corresponded to Phase 3.1 for Cohort 1, and Phase 2.1 for Cohort 2. Exclusion criteria will be different in the final analysis. For now, individuals will be included with complete data up to Phase 2.1 for Cohort 1, and with complete data up to Phase 2.1 for Cohort 2.  
...
```{r exclude_preliminary, include=F}
